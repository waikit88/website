                                ...
                                <div class="form form-profile">
                                    <form action="#">
                                        <div class="row-item clearfix">
                                            ...
                                            <div class="val">
                                                <input class="txt" type="text" id="txt_name1" value="<?php echo $name; ?>">
                                        ...
                                        <div class="row-item clearfix">
                                            ...
                                            <div class="val">
                                                <input class="txt" type="text" id="txt_location" value="<?php echo $location; ?>">
                                        ...
                                        <div class="row-item clearfix">
                                            ...
                                            <div class="val">
                                                <input class="txt" type="text" id="txt_time_zone" value="<?php echo $timezone; ?>">
                                            </div>
                                        </div>
                                        <div class="row-item clearfix">
                                        ...
                                        <div class="row-item clearfix">
                                            ...
                                            <div class="val">
                                                ...
                                                <input class="txt" type="text" id="txt_name2" value="<?php echo $profileurl; ?>">
                                        ...
                                        <div class="row-item clearfix">
                                            ...
                                            <div class="val">
                                                <input class="txt txt-website" type="text" id="txt_web" value="<?php echo $weburl; ?>">
    ...
    <footer id="footer">
        <div class="container_12 main-footer">
            <div class="grid_3 about-us">
                ...
                <p class="rs email"><a class="fc-default  be-fc-orange" href="http://envato.megadrupal.com/cdn-cgi/l/email-protection#99f0f7fff6d9f4fcfef8fdebece9f8f5b7faf6f4"><s"#">Staff Picks</a></li>
  ta-cfemail="7b12151d143b161e1c1a1f090e0b1a1755181416">[email&#160;protected]</span></a></p>
